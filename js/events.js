...
const Events = (() => {
  ...
  const DECISIONS = {
    cara_a_cara: {
      ...
      options: [
        { key: 'forte', label: '💥 Chute forte', outcome: 'goal', chance: a => 0.45 + (a.finalizacao - 60) * 0.014, succ: 'bateu forte e estufou a rede!', fail: 'chutou forte, mas para fora.' },
        { key: 'cavada', label: '🪁 Cavada por cima', outcome: 'goal', chance: a => 0.36 + (a.drible - 60) * 0.014, succ: 'cavou a bola com categoria, sem chances para o goleiro!', fail: 'tentou a cavadinha, mas mandou por cima do travessão.' },
        { key: 'rasteiro', label: '🎯 Chute rasteiro no canto', outcome: 'goal', chance: a => 0.50 + (a.controle - 60) * 0.013, succ: 'bateu rasteiro no cantinho, sem chances!', fail: 'chutou rasteiro, mas o goleiro defendeu.' },
      ],
    },
    chance_clara: {
      prompt: 'Grande chance na área! Qual a decisão?',
      options: [
        { key: 'primeira', label: '⚡ Finalizar de primeira', outcome: 'goal', chance: a => 0.38 + (a.finalizacao - 60) * 0.014, succ: 'finalizou de primeira, gol!', fail: 'finalizou de primeira, mas a bola foi por cima.' },
        { key: 'ajeitar', label: '🎯 Ajeitar e bater', outcome: 'goal', chance: a => 0.47 + (a.controle - 60) * 0.013, succ: 'ajeitou e bateu no cantinho, gol!', fail: 'ajeitou para finalizar, mas a zaga cortou.' },
        { key: 'cruzar', label: '🅰️ Cruzar para o companheiro', outcome: 'assist', chance: a => 0.52 + (a.passe - 60) * 0.013, succ: 'cruzou e o companheiro só empurrou para o gol!', fail: 'cruzou, mas a defesa afastou o perigo.' },
      ],
    },
    penalti: {
    ...
    ultimo_passe: {
      ...
      options: [
        { key: 'curto', label: '🎯 Passe seguro no pé', outcome: 'assist', chance: a => 0.55 + (a.passe - 60) * 0.013, succ: 'tocou preciso e o companheiro só empurrou para o gol!', fail: 'o passe saiu forte demais e a zaga cortou.' },
        { key: 'lancamento', label: '🚀 Lançamento por cima', outcome: 'assist', chance: a => 0.38 + (a.visao - 60) * 0.013, succ: 'lançou com precisão cirúrgica, assistência para o gol!', fail: 'o lançamento saiu longo demais e a defesa afastou.' },
        { key: 'cruzamento', label: '↗️ Cruzamento na área', outcome: 'assist', chance: a => 0.42 + (a.cruzamento_eff - 4) * 0.08, succ: 'cruzou na medida e o companheiro cabeceou para o gol!', fail: 'cruzou, mas a zaga cortou antes do companheiro.' },
      ],
    },
    bola_dividida: {
